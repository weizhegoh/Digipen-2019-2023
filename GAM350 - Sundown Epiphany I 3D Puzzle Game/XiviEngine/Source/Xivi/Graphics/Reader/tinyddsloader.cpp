...
{
const char tinyddsloader::DDSFile::Magic[4] = { 'D', 'D', 'S', ' ' };

bool tinyddsloader::DDSFile::IsCompressed( DXGIFormat fmt )
{
  switch ( fmt )
  {
...
uint32_t tinyddsloader::DDSFile::MakeFourCC( char ch0, char ch1, char ch2, char ch3 )
{
  return ( uint32_t( uint8_t( ch0 ) ) | ( uint32_t( uint8_t( ch1 ) ) << 8 ) |
           ( uint32_t( uint8_t( ch2 ) ) << 16 ) | ( uint32_t( uint8_t( ch3 ) ) << 24 ) );
}

tinyddsloader::DDSFile::DXGIFormat tinyddsloader::DDSFile::GetDXGIFormat( const PixelFormat &pf )
{
...
uint32_t tinyddsloader::DDSFile::GetBitsPerPixel( DXGIFormat fmt )
{
  switch ( fmt )
  {
...
tinyddsloader::Result tinyddsloader::DDSFile::Load( const char *filepath )
{
...
tinyddsloader::Result tinyddsloader::DDSFile::Load( std::istream &input )
{
  m_dds.clear();
...
tinyddsloader::Result tinyddsloader::DDSFile::Load( const uint8_t *data, size_t size )
{
  std::vector<uint8_t> dds( data, data + size );
  return Load( std::move( dds ) );
}

tinyddsloader::Result tinyddsloader::DDSFile::Load( std::vector<uint8_t> &&dds )
{
  m_dds.clear();
...
void tinyddsloader::DDSFile::GetImageInfo( uint32_t w, uint32_t h, DXGIFormat fmt,
...
bool tinyddsloader::DDSFile::Flip()
{
...
bool tinyddsloader::DDSFile::FlipImage( ImageData &imageData )
{
...
bool tinyddsloader::DDSFile::FlipCompressedImage( ImageData &imageData )
{
...
void tinyddsloader::DDSFile::FlipCompressedImageBC1( ImageData &imageData )
{
...
void tinyddsloader::DDSFile::FlipCompressedImageBC2( ImageData &imageData )
{
  uint32_t numXBlocks = ( imageData.m_width + 3 ) / 4;
  uint32_t numYBlocks = ( imageData.m_height + 3 ) / 4;
  if ( imageData.m_height == 1 )
...
void tinyddsloader::DDSFile::FlipCompressedImageBC3( ImageData &imageData )
{
  uint32_t numXBlocks = ( imageData.m_width + 3 ) / 4;
  uint32_t numYBlocks = ( imageData.m_height + 3 ) / 4;
  if ( imageData.m_height == 1 )
...
void tinyddsloader::DDSFile::FlipCompressedImageBC4( ImageData &imageData )
{
  uint32_t numXBlocks = ( imageData.m_width + 3 ) / 4;
  uint32_t numYBlocks = ( imageData.m_height + 3 ) / 4;
  if ( imageData.m_height == 1 )
...
void tinyddsloader::DDSFile::FlipCompressedImageBC5( ImageData &imageData )
{
  uint32_t numXBlocks = ( imageData.m_width + 3 ) / 4;
  uint32_t numYBlocks = ( imageData.m_height + 3 ) / 4;
  if ( imageData.m_height == 1 )
