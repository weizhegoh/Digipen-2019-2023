...
BEGIN_EVENT_TABLE(LogTransformDialog, wxDialog)
EVT_UPDATE_UI(wxID_OK, LogTransformDialog::onUpdateOkButton)
END_EVENT_TABLE()

LogTransformDialog::LogTransformDialog(wxWindow* parent, wxWindowID id, const wxString& title,
...
void LogTransformDialog::onUpdateOkButton(wxUpdateUIEvent& event)
{
    event.Enable(false);
