...
bool ImGui::CheckboxSlide(const char* label, bool* v)
{
   ...
   if (*v) // 
   {
       window->DrawList->AddRectFilled(ImVec2((check_bb.Min.x) / 2, check_bb.Min.y), check_bb.Max, GetColorU32(ImGuiCol_CheckMark), 0);
      // window->DrawList->AddRect(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x), check_bb.Min.y), ImVec2(check_bb.Min.x, check_bb.Min.y), GetColorU32(ImGuiCol_Border), 0);
      window->DrawList->AddRect(ImVec2(check_bb.Min.x, check_bb.Min.y), ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2, check_bb.Max.y), GetColorU32(ImGuiCol_Border), -12);
...
bool ImGui::CheckboxTick(const char* label, bool* v)
{
